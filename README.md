...
resource, policy_arn and role for eks_cluster and eks_nodes are defined in iam.tf to have assume_role_policy as per [Amazon EKS cluster IAM role](https://docs.aws.amazon.com/eks/latest/userguide/service_IAM_role.html) 
