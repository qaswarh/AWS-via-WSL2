...
desired, max and min sizes all set to 1 in scaling_config in ekscluster.tf to keep cluster charges at minimum<br>
resource, policy_arn and role for eks_cluster & eks_nodes are defined in iam.tf with assume_role_policy as per [Amazon EKS cluster IAM role](https://docs.aws.amazon.com/eks/latest/userguide/service_IAM_role.html)<br>
